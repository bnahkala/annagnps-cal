...
wet_area = 2.35 #ha, gisA
wet_area_m2 = wet_area * 10000
max_depth = 1000 #mm
...
for y in range (0, 1):
    ...
    for x in range (0, 25):
        ...
        # import and check
        Bobs_16_18_volume = numpy.loadtxt(fname = obsdata_filename)
        ...
        # calculate
        b_nse = evaluator(nse, sim_output, Bobs_16_18_volume) 
        b_pbias = evaluator(pbias, sim_output, Bobs_16_18_volume) 
        b_rmse = evaluator(rmse, sim_output, Bobs_16_18_volume) 
        sd = stdev(Bobs_16_18_volume)
        b_rsr = b_rmse / sd 
